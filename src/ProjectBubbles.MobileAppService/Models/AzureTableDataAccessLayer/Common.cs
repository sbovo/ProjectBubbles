...
public class Common
{
    ...
    public static async Task<CloudTable> CreateTableAsync(string tableName)
    {
        ...
        string connectionString = "DefaultEndpointsProtocol=https;AccountName=bubblestorageaccount;AccountKey=VWAKv6/EahI329bFXzNnXE9iOGAgSiugKy71TAiFeLPRC+mWkMy4tMsJtxsjrtvR+82lwYr1kdXMLBDiBZ1eTw==;";
